...
import FaqList from '../components/Faqq/FaqList';
      ...
      <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
          ...
          <div>
            <div className='lg:w-[570px]'>
              <h1 className='text-[36px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]'>We help patients live healthy and longer life
              </h1>
              <p className='text__para'>
              Stay Healthy, Stay Ahead!<br/>Book Your Doctor Appointment Today.<br/>Your health, our priority. 
              </p>
  ...
  <section>
    <div className="container">
      <div className='lg:w-[470px] mx-auto'>
          ...
          <p className='text__para text-center'>world-class care for everyone. our health system offers unmatched, expert wealth care.</p>
      </div>
            ...
            <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]' >
                <div className="flex items-center justify-between">
                  <div className='flex items-center gap=[6px] lg:gap-3'>
                    <p className='text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-headingColor font-[600]'>Tue, 4</p>
