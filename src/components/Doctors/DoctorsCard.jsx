    ...
    <div className='p-3 lg:p-5'>
      ...
      <div className='mt-2 lg:mt-4 flex items-center justify-between'>
        ...
        <div className='flex items-center gap-[6px]'>
            <span className='flex items-center gap-[6px] text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-semibold text-headingColor'><img src={starIcon}></img>{avgRating}</span>
            <span className='text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-[400] font-semibold text-textColor'>({totalRating})</span>
        </div>
      </div>
