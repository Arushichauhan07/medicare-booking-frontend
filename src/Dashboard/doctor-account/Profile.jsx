...
//reusable function for adding 
const addItem = (key, item) =>{
    setFormData(prevFormData=> ( console.log("prevFormData",prevFormData),{...prevFormData, [key]:[...prevFormData[key], item]}))
};
...
const deleteTimeSlot = (e, index) => {
  ...
  return (
    <div>
      <h2 className='text-headingColor font-bold text-[24px] leading-7 mb-10'>
      ...
      <form>
        ...
        <div className="mb-5">
            ...
            <button onClick={TimeSlot} className='bg-[#000] py-2 px-5 rounded text-white h-fit cursor-pointer'>Add Time Slots</button>
