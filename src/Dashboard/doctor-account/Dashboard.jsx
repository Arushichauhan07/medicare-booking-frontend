          ...
          <div className='lg:col-span-2'>
            {data.isApproved === 'pending' && <div className='flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg'>
              ...
              >
                <path
                  fillRule='evenodd'
                  d='M18 10a8 0 11-16 0 8 8 0 0 116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000
              ...
              <div className='ml-3 text-sm font-medium'>
                To get approval please complete your profile. We will review and approve in three days.
              </div>
            </div>
            }
            <div className='mt-8'>
                ...
                <div>
                  <div className='flex items-center gap-4 mb-10'>
                    ...
                    <div>
                      <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-4 lg:px-6 rounded text-[12px] leading-4 lg:text-[16px]
                      ...
                      <div className='flex items-center gap-[6px]'>
                          ...
                          leading-5 lg:leading-6 font-semibold '>
                            ({data.totalRating})
                          </span>
                      </div>
